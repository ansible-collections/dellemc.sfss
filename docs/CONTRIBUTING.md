...
All issues related to the associated Ansible modules, roles, playbooks, regardless of the service/repository the issue belongs to (see table above), should be submitted [here](https://github.com/ansible-collections/dellemc.sfss/issues). Issues will be triaged and labels will be used to indicate the type of issue. This section outlines the types of issues that can be submitted.  
...
Before submitting a new issue, make sure someone hasn't already reported the problem. Look through the [existing issues](https://github.com/ansible-collections/dellemc.sfss/issues) for similar issues.

Report a bug by submitting a [bug report](https://github.com/ansible-collections/dellemc.sfss/issues/new?labels=type%2Fbug%2C+needs-triage&template=bug_report.md&title=%5BBUG%5D%3A). Make sure that you provide as much information as possible on how to reproduce the bug.
...
If you have an idea of how to improve this project, submit a [feature request](https://github.com/ansible-collections/dellemc.sfss/issues/new?labels=type%2Ffeature-request%2C+needs-triage&template=feature_request.md&title=%5BFEATURE%5D%3A).

### Answering questions

If you have a question and you can't find the answer in the documentation or issues, the next step is to submit a [question.](https://github.com/ansible-collections/dellemc.sfss/issues/new?labels=type%2Fquestion&template=ask-a-question.md&title=%5BQUESTION%5D%3A)
...
* [Beginner-friendly](https://github.com/ansible-collections/dellemc.sfss/issues?q=is%3Aopen+is%3Aissue+label%3A%22beginner+friendly%22) issues are generally straightforward to complete.
* [Help wanted](https://github.com/ansible-collections/dellemc.sfss/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) issues are problems we would like the community to help us with regardless of complexity.

When you're ready to contribute, it's time to create a pull request.

## Testing
See [here](https://github.com/ansible-collections/dellemc.sfss/tree/collections/tests/README.md) for further information on testing.

## Debugging
To debug OpenManage Ansible Modules using IDE, see [here](https://github.com/ansible-collections/dellemc.sfss/tree/collections/docs/DEBUG.md)
...
* Should include [test](https://github.com/ansible-collections/dellemc.sfss/tree/main/tests/) scripts for your changes.
